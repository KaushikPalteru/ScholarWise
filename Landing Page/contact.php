...
<html lang="en">
  <head>
    ...
    <title>Contact</title>
    <script
      src="https://kit.fontawesome.com/94ab5daaaf.js"
  ...
  >
    ...
    >
      <div class="row">
        <div class="content">
          <div class="col-lg-12">
            <h1>Contact<span style="color: #fff6ea"> Us!</span></h1>
            ...
            >
              ...
              >
                <h3>
                  <div style="box-sizing: border-box" class="d-inline">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                      class="bg-white px-1 d-inline text-center"
                      style="width: 10%; height: 10%; border-radius: 30%"
                    >
