...
if(isset($_POST['submit'])!=""){
  ...
  $link=$_POST['link'];
  $_SESSION['records'] = $entries;
  
  move_uploaded_file($temp,"files/".$name);

$query=$conn->query("INSERT INTO som_upload (name,dept,sem,date) VALUES ('$name','$branch','$sem','$date')");
if($query){
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="table-responsive">
									<form method="post" action="som_delete.php" >
                        				<table cellpadding="0" cellspacing="0" border="0" class="table table-condensed" id="example">
                            				...
                            				<tbody>
												<?php 
													$query=mysqli_query($conn,"select * from som_upload ORDER BY id")or die(mysqli_error($conn));
												...
												<tr>
													...
													<td>
														<a href="som_delete.php?del=<?php echo $row['id']?>"><span class="glyphicon glyphicon-trash" style="font-size:20px; color:red"></span></a>
													</td>
                                				</tr>
