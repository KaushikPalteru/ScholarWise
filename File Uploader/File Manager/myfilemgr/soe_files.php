...
$query=$conn->query("INSERT INTO upload (name,dept,sem,date) VALUES ('$name','$branch','$sem','$date')");
if($query){
header("location:soe_files.php");
}
else{
...
#photo
{
   ...
   font-size: 20px;
		...
		<div class="alert alert-info" style="border-color:none">                     
                            
			&nbsp;&nbsp;SCHOLARWISE/ File Manager/ SOE
		</div>
								...
								<div class="table-responsive">
									<form method="post" action="delete.php" >
                        				<table cellpadding="0" cellspacing="0" border="0" class="table table-condensed" id="example">
                            				...
                            				<tbody>
												<?php 
													$query=mysqli_query($conn,"select * from upload ORDER BY id")or die(mysqli_error($conn));
